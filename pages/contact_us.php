...
<?php include __DIR__ . '/partials/header.php'; ?>
    ...
    <title>Contact Us - Eventy</title>

    <style>
        :root {
            --primary-color: #7f4fdc;
            --primary-dark: #6b3be6;
            ...
            --shadow-light: rgba(127, 79, 220, 0.1);
            --shadow-medium: rgba(127, 79, 220, 0.2);
            --shadow-strong: rgba(127, 79, 220, 0.3);
        }
        ...
        .social-link {
            width: 60px;
            height: 60px;
            background: linear-gradient(135deg, #7f4fdc 0%, #6b3be6 100%);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
...
<body>
    ...
    <section class="contact-hero">
        <div class="container">
            <h1 style="font-size: clamp(2.5rem, 6vw, 4rem); font-weight: 900; margin-bottom: 1rem; background: linear-gradient(135deg, #7f4fdc 0%, #6b3be6 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Get in Touch</h1>
            <p style="font-size: 1.3rem; color: var(--text-secondary); max-width: 600px; margin: 0 auto 2rem;">Have questions about Eventy? We're here to help. Reach out to our team and we'll get back to you as soon as possible.</p>
        </div>
    </section>
            ...
            <div class="contact-container">
                ...
                <div class="contact-info">
                    ...
                    <div class="info-card">
                        ...
                        <p class="info-text">
                            <strong>support@eventy.com</strong><br>
                    ...
                    <div class="info-card">
                        ...
                        <p class="info-text">
                            <strong>Eventy Headquarters</strong><br>
                            Jhocson St., Sampaloc<br>
