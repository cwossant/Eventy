...
<body>
  ...
  <div id="loginModal" class="modal-overlay" role="dialog" aria-modal="true" aria-hidden="true">
    <div class="modal" role="document" aria-labelledby="loginTitle">
        ...
        <!-- IMPORTANT: Added action + method -->
            <form id="loginModalForm" action="login.php" method="POST" class="auth-form" autocomplete="on" novalidate>
...
document.getElementById("loginModalForm").addEventListener("submit", function (event) {
    ...
    // Send login request using AJAX (fetch)
    fetch("login.php", {
        method: "POST",
